...
insert into clientes(nombre, email, telefono, puntos, fecha_registro)
values  
('Richi edit', 'richirich@mail.com', '111222333', 50, '2021-01-11'),
('Ian', 'iancito@gmail.com', '555444333', 120, '2023-09-23');
...
insert into clientes(nombre, email, telefono, puntos, fecha_registro)
values ('Marcos Escolar', 'marquitos24@gmail.com', '666555444' , (SELECT AVG (puntos)), '2024-05-19');
 

-- Delete: ¿Cómo se eliminan todos los clientes registrados hace más de 5 años usando un campo fecha_registro?
		-- delete from clientes where fecha_registro < (Aqui me he quedado, no se como seguirlo)
...
update clientes set puntos = puntos + 20 and fecha_registro = '2024-11-06' where puntos > 100;

-- Insert: ¿Cómo se inserta un cliente y se devuelve el ID generado utilizando la función LAST_INSERT_ID()?
insert into clientes (nombre, email, telefono, puntos, fecha_registro)
values
('Richardo skater', 'richardlison@gmail.com', '123422333', 160, '2021-07-12');		
			-- Hasta aqui llego pero lo de LAST_INSERT_ID() ni idea
